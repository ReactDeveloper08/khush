...
const HrStudentAttendance = props => {
  const {data, batcode, status, absent, facultyAbsent} = props.item;
      ...
      <View style={styles.listContainer}>
        ...
        <View style={styles.dataContainer}>
          <View style={styles.dataLeftAligned}>
            <Text style={styles.infoHeadTextStyle}>{data}</Text>
          </View>
          <View style={styles.centerAlignedContainer}>
            {/* <Text style={styles.infoHeadStyle}>BatchCode</Text> */}
            <Text style={styles.infoHeadTextStyle}>{batcode}</Text>
          </View>
        </View>
...
export default HrStudentAttendance;
