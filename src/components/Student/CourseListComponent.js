...
// Components
import SingleCourseTileComponent from '../../components/SingleCourseTileComponent';

export default class CourseListComponent extends PureComponent {
  constructor(props) {
    super(props);
