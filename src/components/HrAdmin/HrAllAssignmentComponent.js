...
const HrAllAssignmentComponent = props => {
    ...
    <View style={[styles.container]}>
      ...
      <View style={styles.contentContainer}>
        ...
        {/* <View style={styles.rowStyle}>
          ...
          <Text style={styles.bottomTextStyle}>{submittedOn}</Text>
          <Text style={styles.bottomTextStyle}>Grade : {grade}</Text>
        </View> */}
      </View>
...
export default HrAllAssignmentComponent;
