...
export default class QuizUnansweredBookmarksScreen extends Component {
  constructor(props) {
    super(props);
    ...
    if (info) {
      ...
      this.bookmarkedQuestionNumbers = Array.from(
        unansweredBookmarkedQuestionNumbers,
      );
  ...
  render() {
    ...
    const {bookmarkedQuestionNumbers, state} = this;
    const {
      questions,
