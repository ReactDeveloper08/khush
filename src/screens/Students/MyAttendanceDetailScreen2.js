...
export default class MyAttendanceDetailScreen2 extends Component {
  constructor() {
    super();
    this.state = {
  ...
  renderItem = ({item}) => <AttendanceComp item={item} />;
  ...
  fetchAttendance2 = async () => {
    ...
    const {s_id} = userInfo;
    const student_id = s_id; // Replace with actual student ID
    try {
