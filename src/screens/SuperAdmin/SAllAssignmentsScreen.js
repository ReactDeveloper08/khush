...
import SAllAssignmentComponent from '../../components/SuperAdmin/SAllAssignmentComponent';
...
export default class SAllAssignmentsScreen extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.headerContainer}>
          <HeaderComponent
            title="Assignment Summary Details"
            nav={this.props.navigation}
            navAction="back"
          />
        </View>
