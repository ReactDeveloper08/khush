...
export default class HrStudentDetailScreen extends Component {
  constructor(props) {
    super(props);
  ...
  //   return paidModeData.map((item, index) => {
  //     return <PaidModeComponent item={item} nav={this.props.navigation} />;
  //   });
  // };
  renderPaidModeFlatList = () => {
    const {paidModeData} = this.state;
