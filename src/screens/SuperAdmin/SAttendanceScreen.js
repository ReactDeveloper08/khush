...
import SAttendanceBatchComponent from '../../components/SuperAdmin/SAttendanceBatchComponent';
...
export default class HrAttendanceScreen extends Component {
  ...
  render() {
    ...
    const {branchData, selectedBranch} = this.state;
