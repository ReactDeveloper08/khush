...
export default class HrHomeScreen extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const {sliderImage, blogs} = this.state;
    ...
    return (
      <SafeAreaView style={homeStyles.container}>
        {this.state.connectionState && (
          <>
            <HeaderComponent title="Counsellor Home" nav={navigation} />
