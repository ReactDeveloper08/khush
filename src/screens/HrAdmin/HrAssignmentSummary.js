...
import HrAssignmentDateComponent from '../../components/HrAdmin/HrAssignmentDateComponent';
...
export default class HrAssignmentSummary extends Component {
  constructor(props) {
    super(props);
